...
public class QAPFailure {
  ...
  /**
   * Returns the stack trace as an array of lines for proper JSON formatting. This preserves line
   * breaks in the JSON output, making it readable like a JUnit report. Leading tabs are stripped
   * for cleaner output.
   */
