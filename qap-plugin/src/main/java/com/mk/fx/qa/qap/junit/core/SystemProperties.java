...
/**
 * Centralized constants for system property names used across the QAP JUnit extension. Consolidates
 * property names to avoid magic strings and enable easier refactoring.
 */
