...
public class QAPTestClass {
  ...
  private String classFqn; // fully qualified name (e.g.,

  // "com.mk.fx.qa.qap.junit.DemoExtensionUsageTest$MathGroup")

  @JsonProperty("classSimpleName")
  private String
      classSimpleName; // simple name of the class (e.g., "DemoExtensionUsageTest" or "MathGroup")
