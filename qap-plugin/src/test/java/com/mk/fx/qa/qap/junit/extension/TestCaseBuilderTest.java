...
class TestCaseBuilderTest {
  ...
  static class ParamHolder {
    void myTest(String a, int b, boolean c) {}
  }
  ...
  void shouldBuildCompleteTestCase() throws Exception {
    ...
    when(methodCtx.getDisplayName())
        .thenReturn("myTest()"); // auto-generated -> resolver uses @DisplayName
    ...
    assertTrue(
        t.getTestCaseId().contains("Child#myTest") || t.getTestCaseId().contains("Child$"),
  ...
  void shouldGenerateTestCaseIdForParameterizedTest() throws Throwable {
    ...
    QAPJunitMethodInterceptor interceptor =
  ...
  void shouldCaptureParametersWithTypes() throws Throwable {
    ...
    Method m =
        ParamHolder.class.getDeclaredMethod("myTest", String.class, int.class, boolean.class);
    when(ctx.getRequiredTestMethod()).thenReturn(m);
