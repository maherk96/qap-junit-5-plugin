...
public final class ExceptionFormatter {
  ...
  private static QAPFailureLocation extractLocation(Throwable throwable) {
    ...
    return new QAPFailureLocation(className, methodName, fileName, lineNumber > 0 ? lineNumber : null);
  }

  /**
   * Extracts root cause from the exception cause chain by walking getCause() until
   * the last non-null cause is found. This is more reliable than parsing stack traces
   * because frameworks often wrap exceptions.
   *
  ...
  public static QAPFailure fromMessage(String message) {
    ...
    return new QAPFailure(
        "java.lang.RuntimeException", message, null, null, null, null, null);
  }
}
