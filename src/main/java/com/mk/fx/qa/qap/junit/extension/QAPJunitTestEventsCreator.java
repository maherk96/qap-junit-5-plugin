...
public class QAPJunitTestEventsCreator implements ITestEventCreator {
    ...
    public void addTestEventsToTestLaunch(ExtensionContext context, QAPJunitLaunch launch) {
        ...
        if (nodes == null || nodes.isEmpty()) {
            ...
            @SuppressWarnings("unchecked")
            java.util.List<com.mk.fx.qa.qap.junit.model.QAPTest> events = StoreManager.getClassStoreData(
                    context, QAPUtils.METHOD_DESCRIPTION_KEY, java.util.List.class);
            com.mk.fx.qa.qap.junit.model.QAPTestClass launchRoot = launch.getTestClasses().isEmpty()
                    ? null : launch.getTestClasses().get(0);
            if (launchRoot == null) {
                var clazz = context.getRequiredTestClass();
                launchRoot = new com.mk.fx.qa.qap.junit.model.QAPTestClass(
        ...
        if (launchRoot == null) {
            launchRoot = (rootNode != null) ? rootNode : new com.mk.fx.qa.qap.junit.model.QAPTestClass(
        ...
        // Link children
        java.util.Map<String, com.mk.fx.qa.qap.junit.model.QAPTestClass> attach = new java.util.HashMap<>(nodes);
        attach.remove(rootKey); // exclude root

        // Helper to find parent key from a class key
        java.util.function.Function<String, String> parentKey = key -> {
        ...
        java.util.Map<String, java.util.List<com.mk.fx.qa.qap.junit.model.QAPTestClass>> childrenMap = new java.util.HashMap<>();
        ...
        // Attach recursively
        java.util.function.Consumer<com.mk.fx.qa.qap.junit.model.QAPTestClass> attachChildren = new java.util.function.Consumer<>() {
            @Override public void accept(com.mk.fx.qa.qap.junit.model.QAPTestClass node) {
                java.util.List<com.mk.fx.qa.qap.junit.model.QAPTestClass> kids = childrenMap.get(node.getClassKey());
                if (kids != null) {
    ...
    public QAPJunitLaunch startLaunchQAP(ExtensionContext context) {
        ...
        var rootClass = new QAPTestClass(
                clazz.getSimpleName(),
                context.getDisplayName(),
                classTags
        );
